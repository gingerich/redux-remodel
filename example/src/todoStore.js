...
import { createModel, useModel, select } from "redux-remodel";
...
const todos = createModel([], {
  actions: {
    addTodo: (todos, { payload }) => {
      ...
      // return [...todos, { id: uuid(), title: payload }];
    },
...
// let s = app(undefined, app.actions.addTodo("foo"));
// let s2 = app(s, app.actions.addTodo("bar"));
// console.log(s, s2);
